...
func _set_corner_radius(size: int) -> void:
	# set corner radius
	var theme_override = self.get("theme_override_styles/normal")
	theme_override.set("corner_radius_top_left", size)
	theme_override.set("corner_radius_top_right", size)
	theme_override.set("corner_radius_bottom_right", size)
	theme_override.set("corner_radius_bottom_left", size)
